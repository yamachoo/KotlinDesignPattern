...
fun main(args: Array<String>) {
    if (args.size != 2) {
        ...
        println("Example 1: kotlin Main list.html abstractFactory.listFactory.ListFactory")
        println("Example 2: kotlin Main div.html abstractFactory.divFactory.DivFactory")
        exitProcess(0)
    }
